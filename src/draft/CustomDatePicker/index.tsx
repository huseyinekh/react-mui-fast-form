...
export default React.forwardRef(function DatePickerValue(props: IProps, ref) {
  const [value, setValue] = React.useState<Dayjs | null>(props.ignoreDefaultDate === true ? null : dayjs());
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <DemoContainer sx={{ overflow: 'hidden', mt: -1 }} components={['DatePicker', 'DatePicker']}>
        <DatePicker
